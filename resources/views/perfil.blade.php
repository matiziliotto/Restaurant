                ...
                <form method="POST" action="{{ route('actualizarPerfil') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" value="{{$user->direccion}}" required autocomplete="direccion" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{$user->telefono}}" required autocomplete="telefono" autofocus>
